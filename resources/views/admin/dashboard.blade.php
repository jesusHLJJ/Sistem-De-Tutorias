...
<body
    ...
    <div
        class="relative mt-40 sm:mt-44 md:mt-48 w-11/12 max-w-5xl bg-[#044C26]/90 rounded-xl shadow-2xl p-6 sm:p-8 md:p-12 flex flex-col items-center backdrop-blur-sm mb-10">

        <h3
            class="text-white font-montserrat font-medium text-lg sm:text-xl mb-6 sm:mb-8 border-b border-white/30 pb-2 w-full text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-full">
            ...
            <a href="{{ route('admin.profesores.dashboard') }}"
                ...
                <span
                    class="text-white font-montserrat font-bold text-base sm:text-lg tracking-wide group-hover:text-[#A3E635] transition-colors">PROFESORES</span>
            </a>
            ...
            <a href="{{ route('admin.alumnos.dashboard') }}"
                ...
                <span
                    class="text-white font-montserrat font-bold text-base sm:text-lg tracking-wide group-hover:text-[#A3E635] transition-colors">ALUMNOS</span>
            </a>
        ...
        <div class="mt-8 sm:mt-12 w-full border-t border-white/20 pt-4 sm:pt-6 flex justify-center">
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit"
                    class="flex items-center gap-2 sm:gap-3 bg-red-600 hover:bg-red-700 text-white font-montserrat font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-lg shadow-lg transform hover:-translate-y-1 transition duration-200 text-base sm:text-lg">
