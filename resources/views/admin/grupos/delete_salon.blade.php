    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-2xl rounded-2xl" style="background-color: white;">
            <div class="modal-header bg-red-600 text-white">
                <h1 class="modal-title fs-5 font-montserrat font-bold" id="deleteSalonModalLabel">
            ...
            <div class="modal-footer border-t-0">
                ...
                <button type="submit" form="formDeleteSalon" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition">
