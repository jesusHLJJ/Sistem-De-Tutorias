...
<body class="bg-cover bg-center min-h-screen md:min-h-[125vh] flex flex-col relative bg-[url('{{ asset('multimedia/fondo.jpg') }}')] md:[zoom:80%]">

    <!-- Header (Absolute to overlay content) -->
    ...
    <div class="flex flex-1 w-full">
        ...
        <!-- Left Column (Image) -->
        <div class="hidden md:flex w-1/2 bg-[#2C2C2C] items-center justify-center pt-24">
            <img src="{{ asset('multimedia/tesi.png') }}" alt="Logo TESI" class="w-9/12 max-w-2xl">
        </div>

        <!-- Right Column (Form) -->
        <div class="w-full md:w-1/2 flex items-center justify-center pt-28 pb-10 px-4">
            
            <div class="bg-[#D9D9D9]/30 w-full max-w-[482px] h-auto p-6 md:p-8 lg:p-10 rounded-xl shadow-[0_12px_14px_rgba(0,0,0,0.25)] flex flex-col justify-center backdrop-blur-sm">
    ...
    <!-- Footer (Relative to flow) -->
    <div class="w-full h-8 bg-[#13934A] shadow-[0_-12px_14px_rgba(0,0,0,0.25)] z-20 flex-none flex items-center justify-center px-2">
